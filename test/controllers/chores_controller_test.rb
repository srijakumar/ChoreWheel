...
class ChoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chore" do
    assert_difference('Chore.count') do
      post chores_url, params: { chore: { description: @chore.description, title: @chore.title } }
    end
  ...
  test "should update chore" do
    patch chore_url(@chore), params: { chore: { description: @chore.description, title: @chore.title } }
